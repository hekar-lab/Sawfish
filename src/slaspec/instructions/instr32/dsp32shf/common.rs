...
pub fn shift(dst: Expr, src: Expr, size: usize, arithm: bool, sat: bool, id: &str) -> Expr {
    ...
    if arithm {
        code.push(e_copy(
            b_var(res_var),
            e_arshft(src.clone(), e_zext(b_var(shift_var))),
        ));
    } else {
        code.push(e_copy(
            b_var(res_var),
            e_rshft(src.clone(), e_zext(b_var(shift_var))),
        ));
    }
    ...
    if arithm & sat {
        ...
        code.push(e_copy(
            b_var(buf_var),
            e_lshft(e_sext(src.clone()), e_zext(b_var(shift_var))),
        ));
        ...
        code.push(e_copy(
            b_var(res_var),
            e_lshft(src.clone(), e_zext(b_var(shift_var))),
        ));
    }
